      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div class="block">
              <a href="/article_categories.php?categorie=7">Все записи</a>
              <h3>Безопасность [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">

                <?php
                    $articles = mysqli_query( $connection, "SELECT * FROM `articles` WHERE `categorie_id` = 8 ORDER BY `id` DESC LIMIT 4" );
                    while( $art = mysqli_fetch_assoc($articles) ) {
                      ?>
                      <article class="article">
                        <div class="article__image" style="background-image: url(/image/<?php echo $art['image']; ?>);"></div>
            ...
            <div class="block">
              <a href="/article_categories.php?categorie=4">Все записи</a>
